...
# Мінімум векторів, на яких ще має сенс міряти фон. Поріг низький свідомо:
# фон рахується як (кількість запитів-приманок) × (кількість векторів), тож
# навіть два записи дають три десятки замірів. Вищий поріг лишав би щойно
# створену бібліотеку без калібрування текстового простору — а тоді
# транскрипції систематично програють картинкам, бо їхні косинуси живуть
# у зовсім іншому діапазоні.
_MIN_ITEMS = 2
